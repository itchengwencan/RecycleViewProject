...
import adapter.CoverImgSingleTypeRecyAdapter;
...
public class RmListType6 extends BaseHolderType<RmTypeData6, RmListType6.Viewholder> {
    ...
    public BasicRecyViewHolder buildHolder(ViewGroup parent) {
        return new Viewholder(View.inflate(parent.getContext(), R.layout.layout_recommend_typeview6,null));
    }

    @Override
    public void bindDataToHolder(Viewholder holder, RmTypeData6 rmTypeData6, int postion) {
        CoverImgSingleTypeRecyAdapter adapter= new CoverImgSingleTypeRecyAdapter(R.layout.layout_recommend_typeview6_coverimg);
